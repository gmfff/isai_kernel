...
main: main.cu
	nvcc -O3 -w -m64 -Xptxas -dlcm=cg -gencode=arch=compute_86,code=sm_86 -gencode=arch=compute_86,code=compute_86 main.cu -o Dacp -I/usr/local/cuda-11.3/include -L/usr/local/cuda-11.3/lib64 -lcusparse -lcudart
